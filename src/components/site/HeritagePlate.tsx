...
const MOTIFS: Record<NonNullable<Props["motif"]>, React.ReactNode> = {
  ...
  camel: (
    <g fill={G} stroke="none">
      <path d="M18 78c1-6 4-10 9-12l4-1c2-8 8-14 16-16 9-2 17 0 22 4 3 2 7 3 11 3 5 0 8-2 10-6 1-3 3-5 6-6l7-1c2 0 3 1 3 3l-1 3c2 1 3 3 3 5 0 3-2 5-5 5l-6 1-3 7c-2 4-6 6-10 7l-3 12h-4l2-11c-3 0-6 0-9-1l-3 12h-4l3-13c-4-1-7-3-9-6l-4 4 3 15h-4l-3-13c-3 0-6-1-8-3l-2 4 2 12h-4l-3-13c-2 0-4 0-5-1l-1 14h-4l1-15c-2-1-4-3-5-6z" />
      <path d="M95 40c3-1 6 0 7 2l1 3-3 2-5-1-1-3z" />
    </g>
  ),
  wheat: (
    <g fill="none" stroke={G} strokeWidth="1.6" strokeLinecap="round">
